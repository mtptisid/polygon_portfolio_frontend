...
const projects = [
    ...
    },
    {
        ...
        "description": "An AI-powered study assistant that utilizes Google's Gemini LLM to help students with their studies. The application can answer questions, provide explanations, and assist withvarious academic tasks, enhancing the learning experience through intelligent interactions.",
...
const ProjectsPage = () => {
  ...
  useEffect(() => {
    // Hide messages on component mount
